 ...
 * /orders/[id]
 *
 * Customer Order Detail Page — shows full order details, status timeline,
 * tracking reference, and cancel/return action buttons.
 *
 * TICKET-302. Ownership enforced at service layer — returns 404 for
 * another user's order (per docs/03-Security-Access.md §2).
 */
