...
export default function CheckoutErrorBoundary({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        Something went wrong at checkout. Your order was NOT placed. Please try again.
      </p>
