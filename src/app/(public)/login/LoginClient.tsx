  ...
  return (
    <div className="auth-container">
      ...
      <div className="auth-card">
        ...
        <div className="flex items-center gap-3 my-4" style={{ marginBottom: "20px" }}>
          <div style={{ flex: 1, height: "1px", backgroundColor: "var(--color-border)" }} />
          <span className="text-secondary text-xs" style={{ textTransform: "uppercase", fontSize: "11px", color: "var(--color-text-secondary)" }}>or</span>
          <div style={{ flex: 1, height: "1px", backgroundColor: "var(--color-border)" }} />
        </div>
