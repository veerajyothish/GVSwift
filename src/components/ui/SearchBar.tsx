...
export default function SearchBar() {
  ...
  useEffect(() => {
    if (mobileExpanded && searchInputRef.current) {
  ...
  return (
    <div ref={ref} style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
      ...
      >
        {mobileExpanded ? <X size={20} /> : <Search size={20} />}
      </button>

      <div 
        className={mobileExpanded ? '' : 'desktop-search-input'}
      ...
      >
        ...
        {showDropdown && (
          <div style={{
            position: 'absolute',
            top: mobileExpanded ? 'calc(100% + 8px)' : 'calc(100% + 8px)',
            left: mobileExpanded ? '24px' : 0,
            right: mobileExpanded ? '24px' : 0,
